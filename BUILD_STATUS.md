...
| 21  | Intake contract v1.2: device context (os, browser, deviceModel) | 🔄  | [01](docs/tickets/story-21-device-context/issues/01-intake-contract-v1-2-device-context.md) — tracer bullet ([02](docs/tickets/story-21-device-context/issues/02-device-context-tracer-bullet.md)) done 2026-08-29 — squashed to dev at `de36d94`, developer's live phone check against the LAN fullstack gate passed; [03 ship/deploy](docs/tickets/story-21-device-context/issues/03-ship-v1-2-freeze-deploy-handoff.md) pending, so the live wire contract is still v1.1 |
